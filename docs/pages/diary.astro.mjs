...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const diaryListJsonLd = {
    ...
    "hasPart": diaries.map((diary, i) => ({
      "@type": "BlogPosting",
      "headline": `Day ${diaries.length - i}\uFF1A${diary.title}`,
