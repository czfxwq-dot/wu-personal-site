...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$Base, { "title": "\u6A21\u62DF\u60C5\u5883\u4E0B\u7684\u5BB6\u957F\u51B3\u7B56\u4E0E\u5FC3\u7406\u611F\u53D7\u8C03\u67E5", "navActive": "about", "lang": "zh" }, { "default": ($$result2) => renderTemplate` <link rel="stylesheet" href="/src/styles/survey.css">
