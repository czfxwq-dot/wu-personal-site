...
const $$20260706 = createComponent(($$result, $$props, $$slots) => {
  const diaryJsonLd = {
    ...
    "@type": "BlogPosting",
    "headline": "\u5EFA\u7AD9\u7B2C73\u5929\uFF1A73\u5929\uFF0C\u5468\u4E00\uFF0C\u4E00\u53E3\u6C14\u4E0A\u4E866\u4E2A\u529F\u80FD",
