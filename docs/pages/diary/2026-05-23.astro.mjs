...
const $$20260523 = createComponent(($$result, $$props, $$slots) => {
  const diaryJsonLd = {
    ...
    "@type": "BlogPosting",
    "headline": "\u5EFA\u7AD9\u7B2C29\u5929\uFF1A\u641C\u7D22\u5D29\u4E86\uFF0C\u4F46\u5185\u5BB9\u751F\u4EA7\u7EBF\u7B2C\u4E00\u6B21\u8DD1\u901A\u4E86",
